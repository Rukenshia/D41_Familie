...
if(D41_atmGeld < (__GETC__(life_gangPrice))) exitWith {hint format["Du hast nicht genug Geld auf Deinem Bankkonto.\n\nYou lack: $%1",[((__GETC__(life_gangPrice))-D41_atmGeld)] call life_fnc_numberText];};
