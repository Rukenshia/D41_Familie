...
_clothes = switch (life_clothing_store) do
{
	...
	case "gangrr": {[_selection] call life_fnc_clothing_gangrr;};
	case "gangpow": {[_selection] call life_fnc_clothing_gangpow;};
	case "ganglast": {[_selection] call life_fnc_clothing_ganglast;};
