...
if((uiNamespace getVariable["Weapon_Shop_Filter",0]) == 1) then
{
	...
	_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Waffenkomponenten nötig: <t color='#8cff9b'>%1</t></t>",[(_price)] call life_fnc_numberText];
	...
	else
{
	...
	{
		_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Waffenkomponenten nötig: <t color='#ff0000'>%1</t><br/>Dir fehlen: <t color='#8cff9b'>%2</t></t>",[(_price)] call life_fnc_numberText,[(_price - D41_Geld)] call life_fnc_numberText];
	}
		else
	{
		_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Waffenkomponenten nötig: <t color='#8cff9b'>%1</t></t>",[(_price)] call life_fnc_numberText];
