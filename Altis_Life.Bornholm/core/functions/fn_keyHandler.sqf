...
switch (_code) do
{
	...
	case 38:
	{
		if (_shift) then {
			...
			{
				_veh = vehicle player;
				if(_veh != player && (typeOf vehicle player) in ["Offroad_Pol","D41_Offroad_Medic","C_Van_01_box_F","BMW_X6M_Pol","Offroad_SWAT","D41_swat_hunter","D41_Lada_Civ_05","D41_rhsusf_m1025_d"]) then
				{
