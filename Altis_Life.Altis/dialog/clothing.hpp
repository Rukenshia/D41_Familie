class Life_Clothing {
	...
	class controls 
	{
		...
		class FilterList : Life_RscCombo
		{
			...
			x = -0.30 + (1 / 250 / (safezoneW / safezoneH));
			y = 0.5 - (1 / 25);
			w = 0.318;
			h = 0.035;
		};
		...
		class CloseButtonKey : Life_RscButtonMenu 
		{
			...
			x = -0.139 + (1 / 250 / (safezoneW / safezoneH)); //x = 0.161 + (1 / 250 / (safezoneW / safezoneH));
			y = 0.54 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class BuyButtonKey : Life_RscButtonMenu 
		{
			...
			x = -0.3 + (1 / 250 / (safezoneW / safezoneH)); //x = (1 / 250 / (safezoneW / safezoneH));
			y = 0.54 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
