...
private["_PrimWeapon","_SecWeapon","_WpnItems","_Magazines","_Items","_AssignedItems","_Uniform","_Goggles","_Headgear","_Backpack","_Vest","_Pos"];
	...
	[[_PrimWeapon,_SecWeapon,_WpnItems,_Magazines,_Items,_AssignedItems,_Uniform,_Goggles,_Headgear,_Backpack,_Vest,_Pos],"D41_fnc_GWH",false,false] spawn life_fnc_MP;